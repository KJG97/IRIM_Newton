...
"""ALLEX No-Left robot config for dexblind_newton: Newton physics + RelativeJointPosition action."""
...
class AllexNewtonMixinCfg:
    """Set robot to ALLEX No-Left and wire observations to joint names."""
